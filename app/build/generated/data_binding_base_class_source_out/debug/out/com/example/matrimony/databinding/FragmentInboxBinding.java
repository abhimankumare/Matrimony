...
public final class FragmentInboxBinding implements ViewBinding {
  ...
  private FragmentInboxBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView list2) {
  ...
  public static FragmentInboxBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.list2;
      RecyclerView list2 = rootView.findViewById(id);
      if (list2 == null) {
        break missingId;
      }

      return new FragmentInboxBinding((LinearLayout) rootView, list2);
    }
